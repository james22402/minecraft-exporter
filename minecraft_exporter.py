...
class MinecraftCollector(object):
    ...
    def update_metrics_for_player(self,uuid):
        ...
        blocks_mined        = CounterMetricFamily('blocks_mined','Blocks a Player mined')
        blocks_picked_up    = CounterMetricFamily('blocks_picked_up','Blocks a Player picked up')
        player_deaths       = CounterMetricFamily('player_deaths','How often a Player died')
        player_jumps        = CounterMetricFamily('player_jumps','How often a Player has jumped')
        cm_traveled         = CounterMetricFamily('cm_traveled','How many cm a Player traveled, whatever that means')
        player_xp_total     = CounterMetricFamily('player_xp_total',"How much total XP a player has")
        player_current_level= CounterMetricFamily('player_current_level',"How much current XP a player has")
        player_food_level   = CounterMetricFamily('player_food_level',"How much food the player currently has")
        player_health       = CounterMetricFamily('player_health',"How much Health the player currently has")
        player_score        = CounterMetricFamily('player_score',"The Score of the player")
        entities_killed     = CounterMetricFamily('entities_killed',"Entities killed by player")
        damage_taken        = CounterMetricFamily('damage_taken',"Damage Taken by Player")
